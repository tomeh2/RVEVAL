...
/* Module Version: 5.7 */
/* C:\diamond\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n clkgen -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 25.00 -fclkop 50 -fclkop_tol 2.0 -fclkos 66 -fclkos_tol 2.0 -phases 0 -fclkos2 75 -fclkos2_tol 2.0 -phases2 0 -fclkos3 100 -fclkos3_tol 2.0 -phases3 0 -phase_cntl STATIC -fb_mode 1 -fdc C:/lattice/picorv32/pll/clkgen/clkgen.fdc  */
/* Wed Jul 20 12:35:36 2022 */


`timescale 1 ns / 1 ps
module clkgen (CLKI, CLKOP, CLKOS, CLKOS2, CLKOS3)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    output wire CLKOS2;
