...
/* Module Version: 5.7 */
/* C:\diamond\diamond\3.11_x64\ispfpga\bin\nt64\scuba.exe -w -n pll_1 -lang verilog -synth synplify -bus_exp 7 -bb -arch sa5p00 -type pll -fin 25 -fclkop 50 -fclkop_tol 2.0 -fclkos 66 -fclkos_tol 2.0 -phases 0 -fclkos2 75 -fclkos2_tol 2.0 -phases2 0 -fclkos3 100.00 -fclkos3_tol 2.0 -phases3 0 -phase_cntl STATIC -fb_mode 1 -fdc C:/Users/koncarevac/Desktop/Repo/RVEVAL/RVEVAL/PICORV32/RTL/LATTICE/pll/pll_1/pll_1.fdc  */
/* Fri Jul 22 11:01:06 2022 */


`timescale 1 ns / 1 ps
module pll_1 (CLKI, CLKOP, CLKOS, CLKOS2, CLKOS3)/* synthesis NGD_DRC_MASK=1 */;
    input wire CLKI;
    output wire CLKOP;
    output wire CLKOS;
    output wire CLKOS2;
